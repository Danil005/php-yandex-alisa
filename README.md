...
##  Содержание
 ...
 9. [Локальный Webhook.](#%D0%9B%D0%BE%D0%BA%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9-webhook)
...
___
### Что это такое?
Система JSON-блоков построена таким образом, чтобы можно было использовать ее трогая навыки программирования. Вам достаточно прочитать эту документацию и делать уже сейчас свои навыки. Пока эта система находиться на Alpha-стадии.
___
### Файлы обработки
...
|payload.json|Файл для обработки payload запросов (callback).|\dir_project\blocks\payload.js
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0ODM1NTUwMzddfQ==
-->
